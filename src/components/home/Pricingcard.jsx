...
function Pricingcard(props) {
  return (
    <div className="bg-blue-200 flex flex-col pl-16 pt-4 rounded-lg h-[400px]">
      ...
      <button className="font-bold border-2 border-black w-fit rounded-full p-2 mt-4 bg-blue-400 hover:bg-blue-700 text-black">
        Buy Now
      </button>
    </div>
  );
